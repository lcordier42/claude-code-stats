...
def _get_sudo_user_for_path(path):
    """Look up the sudo_user for a path (single-source: always None)."""
    return None
...
def parse_session_transcripts():
    ...
    for projects_dir, sudo_user in sources:
        ...
        for idx, project_dir in enumerate(project_dirs):
            ...
            for jsonl_file in jsonl_files:
                ...
                # Skip if this session was already seen
